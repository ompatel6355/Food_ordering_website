<div class="home-header-logo">
    ...
    <?php
          // echo $_SESSION['email'];
            ...
            <div class="header-search">
              ...
              <input id="area-input1" 
                          oninvalid="InvalidMsg(this);" 
                          oninput="InvalidMsg(this);"
                          name="area"  
                          value = "' .$search1.'"
                          placeholder="' .$search1.'" 
                          required="required" style="border-radius: 5px;" />
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                  ...
                  <li id="profile" onclick="profileModal()" onclick="profileModal()" style="
                  cursor: pointer;"><a  >
...
<div id="profile_modal" style="    width: 30%;">
<div onclick="closeProfile()" class="cross-icon" id="cross-icon" style="float:left;">
        ...
        background: aliceblue;"
            ...
            <div class="flex hover:bg-gray-100 items-center px-4 py-2" style="
        align-items: center;">
        <a onclick="funLogout()" style="margin-right:5px; text-decoration:none;color: black; 
    cursor: pointer;">
                <i style="    border-radius: 50%;
        background: aliceblue;"
